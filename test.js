...
test('TEST FAILURE: Env not found -e', () => expect(shell.exec('node ./script/s3.js -e sakjdh').stderr).toContain('Cannot read property'));

test('TEST FAILURE: Env not found --env', () => expect(shell.exec('node ./script/s3.js --env sakjdh').stderr).toContain('Cannot read property'));
